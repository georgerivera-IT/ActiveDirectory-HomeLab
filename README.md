...
After installing Windows Server 2022 ISO's file and launching from VirtualBox, the System Dashboard immediately pops up after log in. During initial setup, go to the network icon in the bottom right, right-click, and navigate to "Open Network & Internet Settings". After this, configure the static IP address as shown.
...
Check "Active Directory Domain Services" in the listed installations and install.
...
Observe AD and DNS listed in the left panel of Server Manager. Click to ensure it's working, then take a VMware snapshot to save progress to then work on other labs.
